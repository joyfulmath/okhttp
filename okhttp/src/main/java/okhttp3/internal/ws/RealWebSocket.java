 ...
 * be accessed. A prefix of "writer" indicates both "Reader" and "Replier" threads can access.
 */
public abstract class RealWebSocket implements WebSocket, FrameCallback {
  ...
  /**
   * Read a single message from the web socket and deliver it to the listener. Returns false when
